...
public class Pagina2 extends Activity implements TextureView.SurfaceTextureListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Camera camera = CAM.getCameraInstance();
            ...
            camera.setSystemStateCallback(new SystemState.Callback() {
                ...
                public void onUpdate(SystemState cameraSystemState) {
                    if (null != cameraSystemState) {
                        ...
                        Pagina2.this.runOnUiThread(new Runnable() {
    ...
    private void initPreviewer() {
        ...
        BaseProduct product = CAM.getProductInstance();
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(Pagina2.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void captureAction(){
        ...
        final Camera camera = CAM.getCameraInstance();
        if (camera != null) {
